...
<div class="content">
    <div class="page-header">
        <div>
            ...
            <div class="page-description">Enter the product details to create a new listing.</div>
        </div>
        ...
        <div class="card-header">
            <div>
                ...
                <div class="card-subtitle">
                    This product will be created by: <strong><?= htmlspecialchars($current_user_name ?: 'Current User', ENT_QUOTES, 'UTF-8'); ?></strong>
                </div>
            </div>
        </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <div class="form-helper">Preview images will appear after selecting files.</div>
                    </div>
